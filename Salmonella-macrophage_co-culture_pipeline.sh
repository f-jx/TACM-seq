...
# parameters:
    ...
    kk2DBlist=(~/databases/${host}_{1Bc_Stm,ABVF})
    microbeIndexes=(~/project/refSeq/bt2Index/Salmonella_enterica)
    microbeGffs=(~/project/refSeq/fnagff/GCF_000006945.2_ASM694v2_genomic.gff)
